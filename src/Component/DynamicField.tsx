...
export function nonNegativeNumberFilterFunction(value: string): any {
    if (value.length === 0) {
        return -1;
    } else {
...
export function nonNegativeNumberFormatFunction(value: any, mode: DynamicEditFieldMode): string {
